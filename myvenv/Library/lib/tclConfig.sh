...
# installed.
TCL_PREFIX='E:/python/Projects/ML_First_Project/myvenv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='E:/python/Projects/ML_First_Project/myvenv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='E:/python/Projects/ML_First_Project/myvenv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IE:/python/Projects/ML_First_Project/myvenv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LE:/python/Projects/ML_First_Project/myvenv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='E:/python/Projects/ML_First_Project/myvenv\Library\lib\tclstub86.lib'
